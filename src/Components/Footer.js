            ...
            <footer className="text-white-600 body-font bg-gray-600">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                                <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                                    ...
                                    <input type="text" id="footer-field" name="footer-field" className="w-full text-white bg-opacity-50 rounded border border-white focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-white-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                                <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex font-medium text-gray-600 bg-white py-2 px-6 focus:outline-none hover:bg-gray-400 hover:text-white rounded">Subscribe</button>
                            </div>
                ...
                <div className="bg-white-100 ">
                    <div className="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p className="text-sm text-white sm:ml-auto sm:mt-0 mt-4">© 2023 M.Hamza —
                            <a href="#" rel="noopener noreferrer" className="text-white-600 ml-1" target="_blank">mhamzaali184@gmail.com</a>
                        </p>
